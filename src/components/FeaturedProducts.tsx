      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-3">
          <div className="flex items-center justify-center mb-1">
            <Star className="h-4 w-4 md:h-5 md:w-5 text-yellow-500 fill-yellow-500 ml-2" />
            <h2 className="text-base md:text-lg lg:text-xl font-bold text-gray-900 font-arabic">
              المنتجات المميزة
            </h2>
            <Star className="h-4 w-4 md:h-5 md:w-5 text-yellow-500 fill-yellow-500 mr-2" />
          </div>
