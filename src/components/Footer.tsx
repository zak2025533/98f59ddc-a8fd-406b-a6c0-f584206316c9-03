      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li>
                📞 <a href="tel:770006120" className="hover:text-blue-600 transition-colors">770006120</a>
              </li>
              <li>
                📧 <a href="mailto:motahr4742@gmail.com" className="hover:text-blue-600 transition-colors">motahr4742@gmail.com</a>
              </li>
              <li>
                📍 <a 
        ...
        <div className="border-t border-blue-200 mt-8 pt-8 text-center">
          <p className="text-muted-foreground font-arabic">
            بلا حدود - تصميم وتطوير المهندس: زكريا نبيل محمد الحاج | واتساب: ‎780652001
          </p>
          {/* Hidden admin access */}
          <div className="mt-2">
            <Link 
